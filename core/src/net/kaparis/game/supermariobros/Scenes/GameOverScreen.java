...
public class GameOverScreen implements Screen {
    ...
    public GameOverScreen(Game game)
    {
        ...
        stage = new Stage(viewport, ((net.kaparis.game.supermariobros.MarioBrosGame)game).batch);
    ...
    public void render(float delta) {
        ...
        if(Gdx.input.justTouched()) {
            game.setScreen(new PlayScreen((net.kaparis.game.supermariobros.MarioBrosGame) game));
            dispose();
        }
